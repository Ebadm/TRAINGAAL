...
class Generator(nn.Module):
    def __init__(self, seq_len=170, patch_size=17, channels=1, num_classes=9, latent_dim=100, embed_dim=10, depth=3,
...
class PatchEmbedding_Linear(nn.Module):
    def __init__(self, in_channels=21, patch_size=17, emb_size=100, seq_length=1024):
        super().__init__()
        ...
        self.positions = nn.Parameter(torch.randn((seq_length // patch_size) * patch_size + 1, emb_size))
