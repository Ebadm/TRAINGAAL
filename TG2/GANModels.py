...
class Generator(nn.Module):
    def __init__(self, seq_len=60, feature_dim=51, latent_dim=100, embed_dim=128, num_heads=4, num_layers=3):
...
class Discriminator(nn.Module):
    def __init__(self, seq_len=60, feature_dim=51, latent_dim=100, embed_dim=128, num_heads=4, num_layers=3):
        ...
        self.embedding = nn.Linear(feature_dim, seq_len * embed_dim)
        self.positional_encoding = nn.Parameter(torch.zeros(seq_len, embed_dim))
